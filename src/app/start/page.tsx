...
// 個人モードの診断開始画面。
// 2026-06-19: ルート(/)を先生向け玄関(ランディング)に作り替えたのに伴い、
// 旧トップ(/ の Home)の中身をここ(/start)へ退避した。玄関の「個人で診断する」、
// /s の「個人で診断する」、結果の「もう一度診断する」はすべてここへ来る。
// コピー文言・挙動は旧 / と 1:1（移設のみ・内容は不変更）。
...
// ============================================================================
// PC版（≥1024px / lg）の診断開始：中央 split hero。

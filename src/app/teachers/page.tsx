      ...
      <section id="faq" className="mb-12 scroll-mt-6">
        ...
        <div className="mb-8">
          ...
          <Faq
            ...
            short="ベクトルの近さ（コサイン類似度）であり、「向いている確率」ではありません。"
            a="「生徒の 19 軸スコア」と「その学科の 19 軸スコア」が同じ方向を向いているかを百分率化したものです。1 位と 2 位の差が小さい場合は「両方に適性がある」と読んでいただくのが正しい解釈です。"
          />
          <Faq
            q="「あなたは〜なタイプです」という特徴文はどう決まりますか？"
            short="12 種類の文を、軸スコアが閾値を超えた時のみ機械的に表示します。"
          ...
          <Faq
            ...
            short="17 種類の基準を、軸スコアに応じて 3〜4 個機械的に選びます。"
